...
def is_mini_shape(contour, min_area=100, max_area=10000, min_aspect_ratio=0.3, max_aspect_ratio=3):
    ...
    # Check if the contour is roughly upright (taller than wide)
    if h < w:
        return False
...
def main():
    ...
    try:
        ...
        while running[0]:
            ...
            # Detect and draw potential minis
            mini_contours = detect_minis(frame)
            draw_detected_minis(frame, mini_contours)
